...
public class UiThreadSafetyTests
{
    ...
    public void ApplicationProjects_HaveNoSynchronousBlockingOnAsync()
    {
        ...
        foreach (string dir in new[] { "src/PenguinComb.App", "src/PenguinComb.Application", "src/PenguinComb.Infrastructure" })
        {
    ...
    private static string FindRepositoryRoot()
    {
        ...
        {
            if (Directory.Exists(Path.Combine(dir.FullName, "src", "PenguinComb.App")))
            {
                return dir.FullName;
            }
            dir = dir.Parent;
