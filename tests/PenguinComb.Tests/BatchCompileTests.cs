...
{
    private readonly string _root = Path.Combine(Path.GetTempPath(), "penguincomb-batch", Guid.NewGuid().ToString("N"));
    ...
    {
        var data = new PenguinComb.Application.Models.SongProjectData
        {
            gameSelect = "GH3",
            platformSelect = "PC",
            songName = songName,
    ...
    public async Task Batch_ChFolder_IsImportedAsGh3PcProjectAndCompiled()
    {
        ...
        var saved = PenguinComb.Application.Models.SongProjectData.FromJson(File.ReadAllText(savedProject));
    ...
    public void BatchViewModel_CloneHeroLibrary_ScansForSongFolders()
    {
        ...
        var vm = new PenguinComb.App.ViewModels.BatchCompileViewModel(
    ...
    public async Task Batch_ChFolder_NameSuffix_IsAppendedToNameAndTitle()
    {
        ...
        var saved = PenguinComb.Application.Models.SongProjectData.FromJson(
    ...
    public void ChToGh3ViewModel_RemembersGameFolderFromSettings_AndAddsSongs()
    {
        ...
        var vm = new PenguinComb.App.ViewModels.ChToGh3ViewModel(
